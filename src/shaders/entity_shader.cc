...
EntityShader::EntityShader() : Shader{ "entityshader.vert", "entityshader.frag" }, MVPShader(this), MultiTexShader(this), LightShader(this), ClipShader(this), m_depth(false) {
	bind();
	get_uniform_locations();
}

EntityShader::EntityShader(bool depth) : Shader{ "entityshader.vert", "depthshader.frag" }, MVPShader(this), MultiTexShader(this), LightShader(this), ClipShader(this), m_depth(depth) {
	bind();
	get_uniform_locations();
}
